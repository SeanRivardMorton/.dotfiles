...
-- save with jk in normal mode
vim.keymap.set('n', '<leader>jk', '<cmd>w<CR>', { desc = 'Save file' })

-- Obsidian
vim.keymap.set('n', '<leader>on', '<cmd>ObsidianNew<CR>', { desc = 'Creates a new obsidian note' })
vim.keymap.set('n', '<leader>os', '<cmd>ObsidianSearch<CR>', { desc = 'Opens a obsidian file' })
vim.keymap.set('n', '<leader>ot', '<cmd>ObsidianTomorrow<CR>', { desc = 'Opens a new new for tomorrow' })
vim.keymap.set('n', '<leader>od', '<cmd>ObsidianDailies<CR>', { desc = 'Opens todays notes' })
vim.keymap.set('n', '<leader>ol', '<cmd>ObsidianLink<CR>', { desc = 'Creates a link on visual selection' })
vim.keymap.set('n', '<leader>ow', '<cmd>ObsidianWorkspace<CR>', { desc = 'Creates a link on visual selection' })
vim.keymap.set('n', '<leader>oc', '<cmd>ToggleCheckbox<CR>', { desc = 'Creates a checkbox' })
vim.keymap.set('n', '<leader>om', '<cmd>ObsidianNewFromTemplate<CR>', { desc = 'New from template' })

vim.keymap.set('n', '<leader>po', '<cmd>PeekOpen<CR>', { desc = 'New from template' })
vim.keymap.set('n', '<leader>pc', '<cmd>PeekClose<CR>', { desc = 'New from template' })

vim.api.nvim_create_augroup('markdown_keybinds', { clear = true })
vim.api.nvim_create_autocmd('FileType', {
  group = 'markdown_keybinds',
  pattern = 'markdown',
  callback = function()
    vim.api.nvim_buf_set_keymap(0, 'n', 'enter', '<cmd>ToggleCheckbox<CR>', { noremap = true, silent = true })
  end,
})
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[Sxearch [N]eovim files' })
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      require('mini.starter').setup {
        ...
        --  This is where the file browser will start when you open it
        function()
